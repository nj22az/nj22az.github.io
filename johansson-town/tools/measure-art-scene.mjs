...
globalThis.fetch=async path=>{
 ...
 if(!pathname.startsWith('/johansson-town/assets/characters/'))throw new Error('Unexpected model URL: '+path);
 return new Response(await readFile(root+'/assets/characters/'+pathname.split('/characters/')[1]));
};
