...
19 September 2026. Published peninsula layout.
...
Validation: 67 focused checks pass, including complete-town door routes,
...
printing, Thuan’s bench/return-to-work routine, and runtime/source parity.
The published runtime is rebuilt with the source. The review browser has
WebGL disabled, so GPU appearance and device frame rate are unverified.
