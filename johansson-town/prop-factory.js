...
export function createPropFactory({shadows=true,maxAnisotropy=4}={}){
  ...
  function add(parent,geo,mat,pos=[0,0,0],rot=[0,0,0],scale=[1,1,1],cast=shadows){const o=new THREE.Mesh(geo,mat);o.position.set(...pos);o.rotation.set(...rot);o.scale.set(...scale);o.castShadow=cast;o.receiveShadow=cast;parent.add(o);return o;}
