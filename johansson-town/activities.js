...
export function createActivities({say,onWeather,onTime,onCamera}) {
  ...
  let state={...defaults},timer=null,modalOpen=false,previousFocus=null,audio=null,hum=null;
  ...
  $('#creditsButton').onclick=()=>show('Credits','Johansson Town uses Three.js and local procedural geometry. Resource discovery is guided by Fasani/three-js-resources (MIT). Road, plaster, timber and roof textures come from Poly Haven / Texture Haven (CC0). The stable character rigs are original Johansson Town geometry.',[['Texture credits',()=>window.open('./assets/ATTRIBUTION.md','_blank','noopener')],['Resource catalogue',()=>window.open('https://github.com/Fasani/three-js-resources','_blank','noopener')],['Close',close]]);
