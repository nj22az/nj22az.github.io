...
export function buildDistricts(world,options){
  ...
  sign('小学校','GATE CLOSES AT 16:00',[54,2.2,39],3,.8);box([8,1.6,.12],[54,.8,38.5],'timber',0x687566);colliders.push({x:54,z:38.5,w:8,d:.12,height:1.6});verb([54,1,40],'Look through school gate','read','School gate','The last baseball practice has finished. Indoor shoes stand in neat rows beyond the locked gate.');
