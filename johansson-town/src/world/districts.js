...
export function buildDistricts(world,options){
  ...
  for(const x of [-84,-72])box([.6,2,74],[x,-.7,-24],'concrete',0x808f83);
  ...
  box([8,.4,8],[72,5.8,117],'concrete',0xa2a18c);for(const x of [69,75])box([.25,4,.25],[x,8,115],'timber',0x9b4833);box([8,.28,.45],[72,10,115],'timber',0x943d2a);verb([72,7.3,117],'Visit hillside shrine','shrine','Hillside shrine','The bay lies below the roofs.');
  for(const [x,z] of [[69,119],[72,119],[75,119]]){box([.65,1.4,.65],[x,6.7,z],'concrete',0x7f877a);colliders.push({x,z,w:.65,d:.65,minY:6,height:7.4});verb([x,7,z],'Read memorial stone','read','Family memorial','Fresh water, incense and a small bunch of autumn flowers.');}
