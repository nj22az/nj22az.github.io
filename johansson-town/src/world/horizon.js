...
export function addHorizon(parent){
 ...
 for(const [w,d,x,z] of [[900,1000,0,-649.5],[370,86,-265,-106.5],[370,86,265,-106.5]]){const sea=new THREE.Mesh(new THREE.PlaneGeometry(w,d),oceanMat);sea.rotation.x=-Math.PI/2;sea.position.set(x,-.51,z);parent.add(sea);}
