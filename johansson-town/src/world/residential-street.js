...
import {RESIDENTIAL,RESIDENTIAL_BUILDINGS} from './residential-layout.js';
...
export function buildResidentialStreet(world,options={}){
 const group=new THREE.Group();group.name='Willow Alley supplied street';group.position.set(RESIDENTIAL.x,0,RESIDENTIAL.z);world.group.add(group);
 ...
 world.colliders.push({x:RESIDENTIAL.x-1.94,z:RESIDENTIAL.z-.5,w:.96,d:1.26,height:1.85,residential:true});
 let mounted=false;
 function mount(){
