...
export const DINING=Object.freeze({izakayaX:25,izakayaZ:25,izakayaDoor:Object.freeze([25,20]),ramenX:26,ramenZ:10,ramenDoor:Object.freeze([26.65,14.7]),crystalDoor:Object.freeze([23.2,14.7])});
export const NIGHT_LANE=Object.freeze({x:10.5,z:18,y:.05,angle:-Math.PI/2,minX:7.55,maxX:23.61,minZ:14.54,maxZ:21.46});
