...
const ramenGuests=createIndoorResidents({world,parent:scene,place:'ramen',getState:()=>activities.state}),marketClerk=createIndoorResidents({world,parent:scene,place:'market'}),homeGuests=createIndoorResidents({world,parent:scene,place:'home'});
