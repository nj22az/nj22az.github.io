...
export const YURI_PROFILE={...residentialHome('Yuri'),"name":"Yuri","age":25,"role":"Sakura shopkeeper","height":1.64,"work":[-4,-25.5],"evening":[DINING.izakayaDoor[0]-.7,DINING.izakayaDoor[1]],"friend":"Nao","start":540,"close":1200,"retire":1410,"supperStart":null,"supperEnd":null};
...
export const RESIDENTS=ACTIVE_RESIDENT_NAMES.map(name=>{
 ...
 const diningPoint=point=>point&&point[0]===24&&point[1]>=18&&point[1]<=25?[DINING.izakayaDoor[0]-.7,DINING.izakayaDoor[1]]:point;
