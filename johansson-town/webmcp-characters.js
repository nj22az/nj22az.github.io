...
const allowed=new Set(['Aya','Kenji','Mrs Sato','Harbour master','Nao']);
...
const tools=[
  ...
  },
  {
    ...
    inputSchema:{
      type:'object',
      properties:{
        name:{type:'string',enum:['Aya','Kenji','Mrs Sato','Harbour master','Nao']},
        ...
        target:{type:'string',enum:['Johansson','Aya','Kenji','Mrs Sato','Harbour master','Nao']}
      },
