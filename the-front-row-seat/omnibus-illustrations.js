(function () {
  ...
  window.FRONT_ROW_OMNIBUS_ILLUSTRATIONS = {
    watchmans: [
      {
    ...
    chapterOne: [
      ...
      },
      {
        ...
        alt: "Silas stands isolated as the dockworkers rise together; Maggie, Maria and Tom watch from the bar.",
      ...
      },
      {
        ...
        alt: "The room given back to itself: coins gathered from the table while Maria reaches the back stairs.",
