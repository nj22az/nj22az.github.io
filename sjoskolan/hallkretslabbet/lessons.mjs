...
export const CHALLENGES = [
  ...
  { id: 'strom', title: 'Spolens ström', deck: 'v43_03 · övning 7 och formelbladet',
  ...
  { id: 'hall', title: 'Fel: K1 håller inte', deck: 'v43_03 · bild 8', hideFault: true,
    ...
    ask: { key: 'U', label: 'U(a–b)', unit: 'V' }, mask: ['meter', 'nodes', 'I'],
  ...
  { id: 'hallning', title: 'Hållning: över hjälpkontakten', deck: 'v43_03 · övning 3',
    steps: [{}, { s1: true }, { s1: false, red: 'a', black: 'b' }],
    ...
    mistakes: () => [{ v: 24, msg: '24 V skulle det bli över en öppen kontakt. Här är hjälpkontakten sluten.' }] },
  { id: 'avbrott', title: 'Efter strömavbrott', deck: 'v43_03 · bild 9',
    steps: [{}, { s1: true }, { s1: false }, { supply: false }, { supply: true, red: 'b', black: 'c' }],
    ...
    ask: { key: 'U', label: 'U(spole)', unit: 'V' }, mask: ['meter', 'nodes', 'I'],
    ...
    mistakes: () => [{ v: 24, msg: 'Då skulle K1 dra igen av sig själv. Hjälpkontakten öppnade när spänningen försvann.' }] },
];
