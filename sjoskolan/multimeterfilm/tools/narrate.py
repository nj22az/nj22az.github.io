...
if args.preview:
    text="The multimeter compares two points. Select D C volts, with the black lead in COM and the red lead in the voltage socket. Twelve point zero zero volts, plus or minus zero point zero eight volts. Category three, six hundred volts. One megohm in parallel with one megohm is half a megohm."
    parts=[]
