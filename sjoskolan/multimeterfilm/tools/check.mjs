...
import {drawCaptions} from '../src/draw.mjs';
...
assert.equal(T.language,'en-GB');assert.equal(T.voice.name,'bf_emma');assert.equal(T.scenes.length,37);assert.equal(T.chapters.length,12);
