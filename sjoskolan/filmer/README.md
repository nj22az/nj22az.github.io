...
- `check.mjs` – kontrollerar replikerna: högst 15 tecken per sekund, inga överlapp. Kör `node sjoskolan/filmer/check.mjs` före rendering.
...
Regler: Måns ställer frågan och Sigge förklarar. Begreppen följer presentationerna (û för toppvärde, NC/NO, S0/S1, huvudspänning). Samma färger som figurerna (L1 blå, L2 orange, L3 grön, rött bara för det som söks), inga nya exempeltal som krockar med övningarnas svar, och en säkerhetsrad där det passar.

## Granskning

Filmerna har granskats av en lärare, en elinstallatör och en sjöingenjör. Ändringar efter granskningen: långsammare repliker, 60 Hz ombord, IT-nätets jordfel och isolationsvakt, IEC-symboler för NC/NO, överlastskydd F1, återstartsskydd och automatisk omstart av viktiga förbrukare, felsökning i första hand spänningslöst och termografi under last med skydden på.
