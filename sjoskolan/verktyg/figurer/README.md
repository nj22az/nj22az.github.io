...
- `textfix40.py` – innehållsändringar i vecka 40 efter granskningen (nya exempeltal, fartygsexempel, säkerhetsrad). Körs på originalen före `insert.py`.
- `subscripts.py` – byter upphöjda indexbokstäver (Xᴸ) mot nedsänkt text (X_L) i en färdig presentation. Körs sist.
