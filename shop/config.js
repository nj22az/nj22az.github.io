...
var SHOP = {
  ...
  i18n: {
    sv: {
      ...
      privacyWhatBody: "Namn, e-post och telefonnummer som du anger i best\u00e4llningsformul\u00e4ret. Din leveransadress f\u00e5r vi i e-postmeddelandet du skickar. Vi hanterar inga kortuppgifter \u2014 betalning sker via Swish efter att vi bekr\u00e4ftat din best\u00e4llning.",
      privacyWhyH: "Varf\u00f6r",
      privacyWhyBody: "F\u00f6r att svara p\u00e5 din best\u00e4llning, packa varan och skicka den till dig. Vi anv\u00e4nder inte uppgifterna till n\u00e5got annat.",
      privacyKeepH: "Hur l\u00e4nge",
      privacyKeepBody: "Din beställningsmail sparas s\u00e5 l\u00e4nge vi kan beh\u00f6va \u00e5terkomma om leveransen. Vi g\u00f6r inga marknadsf\u00f6ringsutskick.",
      privacyContactH: "Kontakt",
      privacyContactBody: "Vill du veta vilka uppgifter vi har om dig, eller att vi raderar dem? H\u00f6r av dig till samma adress som best\u00e4llningen skickas till.",
    },
    ...
    en: {
      ...
      privacyWhatBody: "Name, email and phone number that you enter in the order form. Your delivery address reaches us via the order email you send. We never see any card details \u2014 payment happens through Swish after we confirm your order.",
      privacyWhyH: "Why",
      privacyWhyBody: "To reply to your order, pack the item and ship it to you. We don\u2019t use this information for anything else.",
      privacyKeepH: "For how long",
      privacyKeepBody: "Your order email is kept for as long as we may need to follow up on the delivery. We don\u2019t send marketing emails.",
      privacyContactH: "Contact",
      privacyContactBody: "Want to know what we have on file, or have it deleted? Just reply to the address the order was sent to.",
    },
  },
